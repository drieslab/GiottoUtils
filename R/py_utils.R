...
#' The options "giotto.py_active_env", "giotto.py_active_ver", and 
#' "giotto.py_active_path" will also be updated with information about the
#' active environment.
#' @returns boolean
#' @examples
#' py_active_env
...
py_active_env <- function() {
    ...
    options("giotto.py_active_path" = py_path)
    return(py_name)
}
