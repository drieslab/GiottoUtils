...
[![R-CMD-check](https://github.com/josschavezf/GiottoUtils/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/josschavezf/GiottoUtils/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
