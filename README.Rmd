...
[![R CMD check](https://img.shields.io/github/actions/workflow/status/drieslab/GiottoUtils/staging_branch_workflow.yml?branch=staging&label=R%20CMD%20check)](https://github.com/drieslab/Giotto/actions/workflows/staging_branch_workflow.yml)
